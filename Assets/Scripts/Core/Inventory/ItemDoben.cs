...
public class ItemDoben : MonoBehaviour
{
    ...
    int solanepsao, int doben, string boxmessage)
    {
        ...
        //PanelItemGiahan.SetActive(true);
        ...
        txtDoben.text = $"Độ bền hiện tại:" + doben + "/1000 + <color=blue>Tăng 1000 MAX </color>";
        // Cập nhật số lượng
    ...
    public void HideItemDetails()
    {
        ...
        txtItemType.text = "";
        txtDescription.text = "";
        PanelItemGiahan.SetActive(false);
