...
{
    public static ChestInventory Singleton;
    ...
    {
        EquipmentManager.Singleton.EquipItem(EquipmentManager.Singleton.item[0], EquipmentManager.Singleton.slotNameMac.ToString());
        if (EquipmentUIManager.Singleton != null)
        {
